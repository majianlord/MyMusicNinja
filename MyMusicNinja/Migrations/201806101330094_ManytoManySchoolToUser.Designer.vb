...
Namespace Migrations
    ...
    Public NotInheritable Partial Class ManytoManySchoolToUser
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(ManytoManySchoolToUser))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201806101330094_ManytoManySchoolToUser"
            End Get
        End Property
