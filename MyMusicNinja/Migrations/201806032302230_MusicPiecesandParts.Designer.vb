...
Namespace Migrations
    ...
    Public NotInheritable Partial Class MusicPiecesandParts
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(MusicPiecesandParts))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201806032302230_MusicPiecesandParts"
            End Get
        End Property
