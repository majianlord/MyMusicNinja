...
Namespace Migrations
    ...
    Public NotInheritable Partial Class DSSSMapping
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(DSSSMapping))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201806031823413_DSSSMapping"
            End Get
        End Property
