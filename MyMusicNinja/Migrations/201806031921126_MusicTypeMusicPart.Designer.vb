...
Namespace Migrations
    ...
    Public NotInheritable Partial Class MusicTypeMusicPart
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(MusicTypeMusicPart))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201806031921126_MusicTypeMusicPart"
            End Get
        End Property
